...
class LaneNetDetector:
    ...
    def __init__(self, path_to_weights='../../../weights/yolopv2.pt'):
        ...
        self.sub_image = rospy.Subscriber('/zed2/zed_node/left/image_raw_color', Image, self.img_callback, queue_size=1)
    ...
    def generate_waypoints(self, lane_mask):
        ...
        offset_pixels = 800  # Estimated distance from left boundary to lane center
